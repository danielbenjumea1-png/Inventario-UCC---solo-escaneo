...
function procesarCodigo(codigo) {
    ...
    setResultsetResult(`✔ Código <span style="font-weight: bold; color: black; font-size: 32px;">${codigo}</span> marcado como encontrado / it has been marked as found`, 'green');
    guardarInventario();
    actualizarTabla();
}
